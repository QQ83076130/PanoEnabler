...
NSMutableDictionary *replaced__ACT_CopyDefaultConfigurationForPanorama()
{
	...
	setIntegerProperty(firebreakDict, @"ACTPanoramaMaxFrameRate", val(prefDict, @"PanoramaMaxFrameRate", (isiPhone4S || isiPhone5Up || isiPad3or4 || isiPadAir || isiPadAir2 || isiPadMini2G) ? 20 : 15, INT))
